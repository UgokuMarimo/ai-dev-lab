...
import ArticleTocSidebar from '@/components/articles/ArticleTocSidebar';
...
export default async function ArticleDetailPage({ params }: ArticlePageProps) {
  ...
  return (
    <div className="py-8 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto my-6 relative">
      {/* Left Author Sidebar */}
      <AuthorSidebar />

      {/* Main Content */}
      <div className="max-w-3xl mx-auto py-8 px-6 sm:px-10 bg-white rounded-2xl border border-slate-300 shadow-sm space-y-8">
        {/* Back Link */}
        <Link
          href="/articles"
      ...
      <ArticleTocSidebar content={article.content} />
    </div>
  );
}
